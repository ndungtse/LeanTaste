            ...
            Lean<span className="text-green-800">Taste</span></p>
              ...
              <div className="forms">
                <form action="" onSubmit={register}>
                  ...
                  FirstName
                  <input
                    onClick={(e)=> setInfo({...info, firstName: e.target.value})}
                   className="px-3 focus:border-2 border-green-800
                   outline-none" type="text" name="firstname" />
                  <br />
                  LastName
                  <input 
                  onClick={(e)=> setInfo({...info, lastName: e.target.value})}
                  className="px-3 focus:border-2 border-green-800
                  ...
                  <br />
                  <input
                  onClick={(e)=> setInfo({...info, mobile: e.target.value})}
                   className="px-3 focus:border-2 border-green-800
                  ...
                  <br />
                  <button className="button text-green-800" type="submit">Sign Up</button>
                  <p>
                    Already have an account? <Link to='/login' className="text-green-800
                    ">Login</Link>
                  </p>
                </form>
              </div>
