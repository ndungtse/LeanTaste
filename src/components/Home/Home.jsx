...
function Home() {
  return (
    <div className='w-full text-white flex flex-col h-screen p-6 bg-[#2b2a2a]'>
        <div className="flex flex-col">
            <img className='w-[20%] ' src={logo} alt="" />
            <p>Here to eat? Enjoy the food</p>
        </div>
        <h1 className="font-bold mt-[2vh] text-center text-4xl">
        ...
        <div className="flex text-white
                justify-center mt-[20vh] mx-auto w-full items-center">
            <Link
                className='py-3 px-[10%]
                 hover:bg-green-800 bg-[#0B6041] rounded-lg border-2'
             to='/signup'>Register</Link>
            <Link
                className='py-3 hover:bg-green-800  ml-4 px-[10%] border-white rounded-lg border-2'
