...
function Home() {
  return (
    <div className='w-full home text-white flex flex-col h-screen p-6 bg-[#2b2a2a]'>
        ...
        >Our aim is to boost your restaurants to five stars and recommend it to various heavy clients</p>
        <div className="flex text-white
                justify-center mt-[15vh] mx-auto w-full items-center">
            <Link
                className='py-3 px-[8%]
                 hover:bg-green-800 bg-[#0B6041] rounded-lg border-2 mb-4'
             to='/signup'>Register</Link>
            <Link
                className='py-3 hover:bg-green-800  ml-4 px-[4%] border-white rounded-lg border-2 mb-4'
        ...
        <div className="grid card grid-cols-3  gap-4 px-[5%] mt-2">
            ...
            <div className=" bg-white h-[40vh]  text-black rounded-lg flex w-full flex-col items-center justify-center">
                ...
                <p className="text-1xl text-center mt-3">Create your restaurant Profile</p>
            </div>
            <div className=" bg-white h-[40vh]  text-black rounded-lg flex w-full flex-col items-center justify-center">
